                    ...
                    <div class="col-12">
                        ...
                        @if(session('status') === 'success')
                            <div class="alert alert-success" id="alert-success" role="alert">
                                ...
                                <p>Kwak-tas-tisch, je event is toegevoegd en moet nog goedgekeurd worden door een event beheerder</p>
                            </div>
                        ...
                        <div class="d-grid">
                            <a href="{{ route(get_admin_name().'.events.create') }}" class="btn btn-outline-secondary mb-4 py-3">
                                <span class="me-2"><span class="fas fa-plus"></span></span>Nieuwe event plaatsen
                            </a>
                        </div>
                    </div>
